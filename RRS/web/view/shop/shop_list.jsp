...
function setMarkers(arrs,arrs2) {
   $(arrs).each(
               function(index, shop) {
                  ...
                  marker.setMap(map);
                  var iwContent = '<div style="padding:5px; width:150px; font-size:small;"><a href="shop_detail.mc?shopid='+shop.shopid+'" style="color:blue; font-size:large;" target="_blank">' + shop.shopname + '</a>'+ ' 추천수(' + arrs2[index].up + ')' + '<br>'+shop.shopphonenumber+'</div>' 
                              ,iwRemoveable = true;
